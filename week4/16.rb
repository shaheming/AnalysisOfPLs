...
data_storage_obj = MyHash.new.add_object {|this|
  this.merge!({  :data=>[],
...
stop_words_obj =  MyHash.new.add_object  {|this|
  this.merge! ({
      :stop_words=>[],
...
word_freqs_obj =MyHash.new.add_object  {
  |this|
  this.merge!(
  {
      :freqs=>Hash.new(0),
...
word_freqs_obj.add_object{|this|
  this[:top25] = ->(){
